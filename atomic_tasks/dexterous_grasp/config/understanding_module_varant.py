...
file_paths = FilePaths(
    ...
    msc_lib=os.path.join(project_root_path, "dexterous_grasp/config/unittest_assets/understanding/libmsc.so"),
    audio_file=os.path.join(project_root_path, "dexterous_grasp/config/unittest_assets/understanding/mp3/command.wav"),
    start_recording_audio=os.path.join(project_root_path, "dexterous_grasp/config/unittest_assets/understanding/mp3/start_recording.mp3"),
    stop_recording_audio=os.path.join(project_root_path, "dexterous_grasp/config/unittest_assets/understanding/mp3/start.mp3")
)
