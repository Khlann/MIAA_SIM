...
class IntelRealSense(LoggerValidator):
    def __init__(self, depth_res=(1024, 768), color_res=(1920, 1080), depth_format=rs.format.z16,
                 color_format=rs.format.bgr8, fps=30, exposure=250, gain=16, logger_manager=None):
    ...
    def capture_current_info(self):
        ...
        self.logger_manager.save_image(self.color_image, "captured_image.jpg", self)
