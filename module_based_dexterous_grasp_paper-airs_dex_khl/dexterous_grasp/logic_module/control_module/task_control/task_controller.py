...
class TaskController(LoggerValidator):
    def __init__(self, arm_motion_params, hand_motion_params, hand_device_params, robot_arm_ip_address, logger_manager=None):
        ...
        self.robotic_arm_controller = RoboticArmController(robot_arm_ip_address, arm_motion_params, logger_manager=logger_manager)
